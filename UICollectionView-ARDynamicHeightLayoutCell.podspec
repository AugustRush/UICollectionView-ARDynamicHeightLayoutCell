#
#  Be sure to run `pod spec lint UICollectionView-ARDynamicHeightLayoutCell.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/AugustRush/UICollectionView-ARDynamicHeightLayoutCell.git", :tag => "0.75" }
